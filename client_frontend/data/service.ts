...
// Used by: Services listing page, dynamic [slug] pages, sidebar nav.

export interface ServiceStaffingOption {
  title: string;
  description: string;
}
...
const SERVICES: ServiceData[] = [
  // 1 ── CONCIERGE & FRONTDESK ─────────────────────────────────────────────
  {
    ...
    excerpt:
      "Premium lobby and frontdesk staffing that elevates your property's image and keeps tenants satisfied 24/7.",
    intro: [
    ...
    staffingIntro:
      "Virginia Surveillance Force Concierge Service never goes out of style. We provide top notch quality service and offer:",
    staffingOptions: [
    ...
    closing:
      "Virginia Surveillance Force provides concierge services throughout Virginia, Washington DC & Maryland areas. When it comes to concierge services, Virginia Surveillance Force Concierge are at the top of their class.",
  },
  ...
  // 2 ── FIRE WATCH ─────────────────────────────────────────────────────────
  {
    ...
    excerpt:
      "Licensed fire watch officers available around the clock to keep your property compliant and safe during system outages.",
    intro: [
    ...
    closing:
      "Virginia Surveillance Force is the trusted name for fire watch services across Virginia, Maryland, and Washington DC. Contact us today to arrange immediate coverage.",
  },
  ...
  // 3 ── VEHICLE PATROL ─────────────────────────────────────────────────────
  {
    ...
    excerpt:
      "Marked and unmarked vehicle patrols providing visible deterrence and rapid response across large or multi-site properties.",
    intro: [
  ...
  // 4 ── PERMANENT OR TEMPORARY SECURITY ────────────────────────────────────
  {
    ...
    excerpt:
      "Flexible uniformed security staffing for both long-term contracts and short-notice temporary assignments.",
    intro: [
    ...
    closing:
      "Virginia Surveillance Force is your trusted partner for flexible, professional security staffing across the DC Metro region.",
  },
  ...
  // 5 ── OFFICE & CORPORATE SECURITY ────────────────────────────────────────
  {
    ...
    excerpt:
      "Discreet, professional security solutions tailored to corporate environments, protecting people, assets, and information.",
    intro: [
    ...
    closing:
      "Protect your people and your business with Virginia Surveillance Force corporate security services across Virginia, Maryland, and Washington DC.",
  },
  ...
  // 6 ── MALLS / RETAIL / INDUSTRIAL ────────────────────────────────────────
  {
    ...
    excerpt:
      "High-traffic retail and industrial security solutions covering loss prevention, crowd control, and perimeter protection.",
    intro: [
    ...
    closing:
      "Trust Virginia Surveillance Force to keep your retail, warehouse, or industrial facility secure across the Virginia, Maryland, and DC metro region.",
  },
  ...
  // 7 ── HOTEL / MOTEL / RESORTS ─────────────────────────────────────────────
  {
    ...
    excerpt:
      "Hospitality-focused security officers who protect guests and staff while preserving the welcoming atmosphere of your property.",
    intro: [
    ...
    closing:
      "Virginia Surveillance Force provides hospitality security services throughout Virginia, Maryland, and the Washington DC area.",
  },
  ...
  // 8 ── RESIDENTIAL & GATED COMMUNITIES ────────────────────────────────────
  {
    ...
    excerpt:
      "Community-focused security for apartment complexes and gated neighborhoods that residents can rely on every day.",
    intro: [
    ...
    closing:
      "Contact Virginia Surveillance Force to build a customized security program for your residential community.",
  },
  ...
  // 9 ── HOSPITAL & HEALTH CARE ──────────────────────────────────────────────
  {
    ...
    excerpt:
      "Specialized healthcare security officers trained to handle the unique and sensitive environment of hospitals and clinics.",
    intro: [
    ...
    closing:
      "Virginia Surveillance Force delivers compassionate, professional healthcare security throughout Virginia, Maryland, and Washington DC.",
  },
  ...
  // 10 ── SCHOOLS / COLLEGES / UNIVERSITIES ──────────────────────────────────
  {
    ...
    excerpt:
      "Campus security solutions that create safe learning environments while fostering a positive community atmosphere.",
    intro: [
    ...
    closing:
      "Protect your educational community with Virginia Surveillance Force campus security services across the DC Metro region.",
  },
  ...
  // 11 ── GOVERNMENT & DIPLOMAT FACILITIES ───────────────────────────────────
  {
    ...
    excerpt:
      "Cleared, professional security personnel meeting the elevated standards required for government and diplomatic sites.",
    intro: [
    ...
    closing:
      "Virginia Surveillance Force is a trusted partner for government and diplomatic security throughout the National Capital Region.",
  },
  ...
  // 12 ── ALARM RESPONSE ─────────────────────────────────────────────────────
  {
    ...
    excerpt:
      "Rapid alarm response officers dispatched immediately to verify and secure your property when an alarm activates.",
    intro: [
    ...
    closing:
      "Trust Virginia Surveillance Force for reliable, rapid alarm response across Virginia, Maryland, and Washington DC.",
  },
  ...
  // 13 ── BANK SECURITY & ATM ────────────────────────────────────────────────
  {
    ...
    excerpt:
      "Armed and unarmed bank security officers and ATM monitoring protecting financial institutions and their customers.",
    intro: [
    ...
    closing:
      "Virginia Surveillance Force is the trusted security partner for financial institutions across the DC Metro region.",
  },
  ...
  // 14 ── INVESTIGATIONS & INTELLIGENCE ─────────────────────────────────────
  {
    ...
    excerpt:
      "Licensed private investigation services covering surveillance, background checks, and corporate intelligence gathering.",
    intro: [
    ...
    closing:
      "Contact Virginia Surveillance Force for confidential, professional investigation services across the DC Metro region.",
  },
  ...
  // 15 ── VIP EXECUTIVE PROTECTION & BODYGUARD ───────────────────────────────
  {
    ...
    excerpt:
      "Discreet, highly trained executive protection specialists securing VIPs, executives, and dignitaries.",
    intro: [
  ...
  // 16 ── COURIER & DELIVERY ─────────────────────────────────────────────────
  {
    ...
    excerpt:
      "Secure, time-sensitive courier and document delivery services handled with chain-of-custody integrity.",
    intro: [
    ...
    closing:
      "Trust Virginia Surveillance Force for secure, reliable courier services throughout Virginia, Maryland, and Washington DC.",
  },
];
...
/** Find one service by slug — returns undefined if not found */
export function getServiceBySlug(slug: string): ServiceData | undefined {
  return SERVICES.find((s) => s.slug === slug);
}

/** All slugs — use in generateStaticParams */
