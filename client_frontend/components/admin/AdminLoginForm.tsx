...
export default function AdminLoginForm() {
  ...
  return (
    <div className="flex w-full max-w-[980px] overflow-hidden rounded-3xl bg-[#131e35] shadow-[0_25px_60px_rgba(0,0,0,0.12),0_0_0_1px_rgba(0,0,0,0.04)]">
      ...
      <div className="relative hidden w-[46%] min-h-[580px] overflow-hidden md:block">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-9">
          ...
          {/* Bottom text */}
          <div>
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#131e35]/10 backdrop-blur-sm border border-white/10 mb-4">
      ...
      {/* Right Panel — Form */}
      <div className="flex-1 flex flex-col justify-center px-12 py-13 bg-[#131e35]">
        <div className="max-w-[360px] w-full mx-auto">
          ...
          {/* Header */}
          <div className="mb-9">
            <h2 className="font-[family-name:var(--font-bebas)] text-[38px] tracking-[2px] text-white leading-none mb-2">
              Welcome Back
            </h2>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center pr-3.5 bg-transparent border-none cursor-pointer text-[#94a3b8] hover:text-[#cbd5e1] transition-colors"
                >
                  {showPassword ? (
