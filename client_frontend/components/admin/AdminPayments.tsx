          ...
          <div className="bg-[#131e35] rounded-2xl overflow-hidden border border-[rgba(201,168,76,0.12)] shadow-[0_4px_16px_rgba(0,0,0,0.04)]">
            ...
            {isLoading ? (
              <div className="py-20 text-center flex flex-col items-center gap-3.5">
                ...
                <p className="text-sm text-[#8898aa] font-medium">Loading payments...</p>
              </div>
            ) : error ? (
              ...
              <div className="py-20 text-center">
                <div className="w-16 h-16 rounded-[20px] bg-gradient-to-br from-[#e0e7ff] to-[#ede9fe] flex items-center justify-center mx-auto mb-4">
                  <CreditCard className="h-7 w-7 text-[#eab308]" />
                </div>
                <p className="text-[15px] font-bold text-white">No Payments Found</p>
                      ...
                      return (
                        <tr key={sub._id} className="border-b border-[rgba(201,168,76,0.1)] hover:bg-[#1a2845]/50 transition-colors">
                          <td className="py-4 px-[22px]">
                            <div className="text-[13px] font-semibold text-[#f4f6f8]">{sub.firstName} {sub.lastName}</div>
                          </td>
                          <td className="py-4 px-[22px]">
                            <a href={`mailto:${sub.email}`} className="text-[12px] font-medium text-[#e8c97a] hover:underline">{sub.email}</a>
                          </td>
                          <td className="py-4 px-[22px] text-xs text-[#8898aa]">{formattedDate}</td>
                          <td className="py-4 px-[22px]">
                            <div className="text-[14px] font-bold text-[#f4f6f8]">
