...
import type { ServiceData, ServiceSection } from "@/lib/page-services";
...
function ServicesSidebar({ currentSlug, services, onServiceClick }: ServicesSidebarProps) {
    return (
...
// ── Prev / Next ────────────────────────────────────────────────────────────
function PrevNextNav({ currentSlug, services }: { currentSlug: string, services: ServiceData[] }) {
...
export default function ServiceDetailClient({ service, allServices }: ServiceDetailClientProps) {
    ...
    const handleServiceClick = (slug: string) => {
        if (slug === service.slug && window.innerWidth <= 960) {
            scrollToContent();
        }
    };
            ...
            <div className="sd-page">
                <div className="sd-layout">
                    ...
                    <FadeIn delay={0.2} direction="left">
                        <ServicesSidebar currentSlug={service.slug} services={allServices} onServiceClick={handleServiceClick} />
                    </FadeIn>
                    ...
                    <main ref={contentRef} className="sd-content">
                            ...
                            <>
                                ...
                                <FadeIn delay={0.05}>
                                    <h2 className="sd-staffing-heading">
                                        ...
                                        {service.staffingHeading.includes("!") && <span>!</span>}
                                    </h2>
                                    <div className="gold-bar" />
                        ...
                        <PrevNextNav currentSlug={service.slug} services={allServices} />
                    </main>
