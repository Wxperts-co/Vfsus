          ...
          <section className="relative py-16 overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_80%_55%_at_50%_0%,rgba(201,168,76,0.07)_0%,transparent_70%)] before:pointer-events-none">
            <div className="container mx-auto px-3 sm:px-4 lg:px-5 xl:px-6 2xl:px-8">
              <AnimatedSection delay={0} className="flex flex-col items-center text-center">
                ...
                <h3 className="section-headline text-4xl sm:text-5xl lg:text-[3.2rem] tracking-wide leading-tight font-extrabold mb-5">
                  Our professionals are available to you<br></br> 24 hours a day, 7 days a week.
                </h3>
                <div className="w-14 h-[3px] bg-gradient-to-r from-[#c9a84c] to-[#e8c97a] rounded mb-7" />
                <p className="mx-auto text-[1.05rem] font-light leading-[1.85] text-[rgba(244,246,248,0.78)] mb-10">
                  <strong className="text-white font-semibold">VIRGINIA SURVEILLANCE FORCE</strong> has become
                  the trusted name in Business, Security and Protective Services. We provide only the best
                  personnel to meet your needs. We have extensive experience in all facets of security &amp;
                  business services and we possess the resources and manpower required to meet the demands of
                  our customers. We would welcome the opportunity to earn your trust and deliver you the best
                  service in the industry. Wherever you have security or business needs...we&apos;ve got the
                ...
                <div className="container mx-auto px-3 sm:px-4 lg:px-5 xl:px-6 2xl:px-8 relative z-10">
                  ...
                  <AnimatedSection delay={0.1}>
                    <div className="video-frame-wrapper relative rounded overflow-hidden shadow-[0_0_0_1px_rgba(201,168,76,0.3),0_24px_80px_rgba(0,0,0,0.7),0_0_60px_rgba(201,168,76,0.07)] before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-br before:from-[rgba(201,168,76,0.08)] before:to-transparent before:pointer-events-none before:z-[1]">
                      <iframe
                        src="https://fast.wistia.net/embed/iframe/zpq664bxly"
                        scrolling="no"
                        allowFullScreen
          ...
          <section className="py-16 pb-24 border-t border-[rgba(201,168,76,0.12)]">
            <div className="max-w-6xl mx-auto px-7">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                {SERVICES.map((item: ServiceData, i: number) => (
