...
export default function QuoteRequest() {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.jobsite_location) newErrors.jobsite_location = 'Job site location is required';
        if (!formData.city2) newErrors.city2 = 'City is required';
        if (!formData.statezip2) newErrors.statezip2 = 'State & Zip is required';
        if (!formData.jobsite_specification) newErrors.jobsite_specification = 'Job site duties are required';

        // Schedule Validation
        if (!formData.Start_Month || formData.Start_Month === 'select') newErrors.Start_Month = 'Start month is required';
        if (!formData.Start_Day || formData.Start_Day === 'select') newErrors.Start_Day = 'Start day is required';
        if (!formData.End_Month || formData.End_Month === 'select') newErrors.End_Month = 'End month is required';
        if (!formData.End_Day || formData.End_Day === 'select') newErrors.End_Day = 'End day is required';
        if (!formData.hours_service) newErrors.hours_service = 'Service hours per day is required';
        if (!formData.perweek) newErrors.perweek = 'Hours per week is required';
        if (!formData.duties_perform) newErrors.duties_perform = 'Duties expected are required';
        ...
        if (!formData.guards_needed) newErrors.guards_needed = 'Number of officers needed is required';
        if (!formData.permanent) newErrors.permanent = 'Please specify service type';
        if (!formData.workHours && !formData.workDurationOthers) newErrors.workHours = 'Work hours are required';
        if (!formData.serviceTiming) newErrors.serviceTiming = 'Service timing is required';
                ...
                <div className="bg-[#0b1120] min-h-screen py-20">
                    <div className="container mx-auto px-4 max-w-2xl">
                        <div className="bg-[rgba(39,174,96,0.1)] border border-[#27ae60] rounded-lg p-8 text-center">
                            ...
                            <h3 className="text-white text-2xl mb-3 font-['Bebas_Neue',sans-serif]">Thank You!</h3>
                            <p className="text-[#8898aa]">Your quote request has been submitted successfully. We'll get back to you within 24 hours.</p>
                        </div>
                    </div>
                </div>
            </>
                    ...
                    <div className="mb-10">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6">
                            ...
                            <div className="flex-shrink-0">
                                <img src="/images/trust.gif" alt="Trust" className="w-24 h-auto" />
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} onReset={handleReset} className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 bg-[#131e35] border border-[rgba(201,168,76,0.2)] rounded-md text-white focus:border-[#c9a84c] focus:outline-none"
                                    />
                                    {errors.webaddress && <p className="text-red-500 text-xs mt-1">{errors.webaddress}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 bg-[#131e35] border border-[rgba(201,168,76,0.2)] rounded-md text-white focus:border-[#c9a84c] focus:outline-none"
                                    />
                                    {errors.statezip && <p className="text-red-500 text-xs mt-1">{errors.statezip}</p>}
                                </div>
                        ...
                        <div className="bg-[rgba(19,30,53,0.5)] rounded-lg p-6 md:p-8 border border-[rgba(201,168,76,0.1)]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-2">
                                        <span className="text-[#c9a84c]">*</span> Type of Organization
                                    </label>
                                    <select
                                        name="toO"
                                        value={formData.toO}
                                    ...
                                    {errors.toO && <p className="text-red-500 text-xs mt-1">{errors.toO}</p>}
                                </div>

                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-2">
                                        <span className="text-[#c9a84c]">*</span> Location of Job Sites
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        className="w-full px-4 py-2 bg-[#131e35] border border-[rgba(201,168,76,0.2)] rounded-md text-white focus:border-[#c9a84c] focus:outline-none"
                                    />
                                    {errors.jobsite_location && <p className="text-red-500 text-xs mt-1">{errors.jobsite_location}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 bg-[#131e35] border border-[rgba(201,168,76,0.2)] rounded-md text-white focus:border-[#c9a84c] focus:outline-none"
                                    />
                                    {errors.city2 && <p className="text-red-500 text-xs mt-1">{errors.city2}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 bg-[#131e35] border border-[rgba(201,168,76,0.2)] rounded-md text-white focus:border-[#c9a84c] focus:outline-none"
                                    />
                                    {errors.statezip2 && <p className="text-red-500 text-xs mt-1">{errors.statezip2}</p>}
                                </div>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    />
                                    {errors.jobsite_specification && <p className="text-red-500 text-xs mt-1">{errors.jobsite_specification}</p>}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[rgba(19,30,53,0.5)] rounded-lg p-6 md:p-8 border border-[rgba(201,168,76,0.1)]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-2">
                                        <span className="text-[#c9a84c]">*</span> Starting Date of Service
                                    </label>
                                ...
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-2">
                                        <span className="text-[#c9a84c]">*</span> Ending Date of Service
                                    </label>
                                    <div className="grid grid-cols-2 gap-3">
                                        <select
                                            name="End_Month"
                                ...
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-2">
                                        <span className="text-[#c9a84c]">*</span> Service Hours Per Day
                                    </label>
                                    <input
                                        type="text"
                                        name="hours_service"
                                        ...
                                        className="w-full px-4 py-2 bg-[#131e35] border border-[rgba(201,168,76,0.2)] rounded-md text-white focus:border-[#c9a84c] focus:outline-none"
                                    />
                                    {errors.hours_service && <p className="text-red-500 text-xs mt-1">{errors.hours_service}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 bg-[#131e35] border border-[rgba(201,168,76,0.2)] rounded-md text-white focus:border-[#c9a84c] focus:outline-none"
                                    />
                                    {errors.perweek && <p className="text-red-500 text-xs mt-1">{errors.perweek}</p>}
                                </div>

                                <div className="md:col-span-2">
                                    <label className="block text-[#8898aa] text-sm mb-2">
                                        <span className="text-[#c9a84c]">*</span> Duties expected of VSF Personnel
                                    </label>
                                    <textarea
                                        name="duties_perform"
                                        ...
                                        className="w-full px-4 py-2 bg-[#131e35] border border-[rgba(201,168,76,0.2)] rounded-md text-white focus:border-[#c9a84c] focus:outline-none resize-y"
                                    />
                                    {errors.duties_perform && <p className="text-red-500 text-xs mt-1">{errors.duties_perform}</p>}
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-3">
                                        <span className="text-[#c9a84c]">*</span> Type of Officer/Personnel requested
                                    </label>
                                ...
                                {/* Services Checkboxes */}
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-3">Services Required</label>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        {[
                                            'Security Service', 'Concierge Service', 'On Site Officer with Marked Vehicle',
                                            'Courier & Delivery Services', 'Vehicle Patrol Service', 'Investigations',
                                            'Alarm Response Service', 'Executive Protection', 'Bank ATM Service'
                                        ].map(service => (
                                ...
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-2">
                                        <span className="text-[#c9a84c]">*</span> How Many Duty Officers or VSF Personnel Needed per shift?
                                    </label>
                                    <select
                                        name="guards_needed"
                                    ...
                                    {errors.guards_needed && <p className="text-red-500 text-xs mt-1">{errors.guards_needed}</p>}
                                </div>

                                {/* Permanent or Temporary */}
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-3">
                                        <span className="text-[#c9a84c]">*</span> Are you seeking permanent or yearly service contract or temporary services?
                                    </label>
                                    ...
                                    {errors.permanent && <p className="text-red-500 text-xs mt-1">{errors.permanent}</p>}
                                </div>

                                {/* Work Hours */}
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-3">
                                        <span className="text-[#c9a84c]">*</span> Approximately what hours will the staff work?
                                    </label>
                                ...
                                <div>
                                    <label className="block text-[#8898aa] text-sm mb-3">
                                        <span className="text-[#c9a84c]">*</span> How soon will you be needing this service?
                                    </label>
                                    <div className="flex flex-wrap gap-6">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input
                                    ...
                                    {errors.serviceTiming && <p className="text-red-500 text-xs mt-1">{errors.serviceTiming}</p>}
                                </div>
                            </div>
                        </div>
