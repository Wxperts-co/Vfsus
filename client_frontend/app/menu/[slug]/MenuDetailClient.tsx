...
import { MenuPageData, MenuListItem, FAQListItem, ResourceArticle, MenuSection } from "@/lib/page-menu";
import { 
  ChevronDown, 
  FileCheck, 
  ShieldCheck, 
...
function MenuSidebar({ currentSlug, menus }: MenuSidebarProps) {
  return (
    <aside className="sidebar-wrap">
      <div className="sidebar-label">Menu List Tabs</div>
      <nav className="sidebar-nav">
        {menus.map((item: MenuListItem) => {
...
function PrevNextMenuNav({ currentSlug, menus }: { currentSlug: string, menus: MenuListItem[] }) {
  const idx = menus.findIndex((item) => item.slug === currentSlug);
  const prev = idx > 0 ? menus[idx - 1] : null;
  const next = idx < menus.length - 1 ? menus[idx + 1] : null;
      ...
      <div className="menu-page">
        <div className="menu-layout">
          ...
          <FadeIn delay={0.15} direction="left">
            <MenuSidebar currentSlug={menuItem.slug} menus={data.menus} />
          </FadeIn>
          ...
          <main ref={contentRef} className="menu-content">
                      ...
                      <div className={`accordion-item ${isOpen ? "accordion-item--active" : ""}`}>
                        ...
                        {isOpen && (
                          <div className="accordion-content">
                            ...
                            {faq.images && faq.images.length > 0 && <DocumentMockupsGrid />}
            ...
            <PrevNextMenuNav currentSlug={menuItem.slug} menus={data.menus} />
